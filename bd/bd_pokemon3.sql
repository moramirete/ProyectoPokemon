...
CREATE TABLE MOVIMIENTO(
    ...
    TIPO VARCHAR(20)CHECK (TIPO IN('ATAQUE', 'ESTADO','MEJORA')) NOT NULL,
    TIPO_MOV VARCHAR(20) CHECK (TIPO IN('AGUA','BICHO','DRAGON','ELECTRICO','FANTASMA','FUEGO','HIELO','LUCHA','NORMAL','PLANTA','PSIQUICO','ROCA','TIERRA','VENENO','VOLADOR')) NOT NULL,
    -- ATAQUE
    POTENCIA INT,
    -- ESTADO
    ESTADO VARCHAR(20) CHECK (ESTADO IN ('NORMAL', 'PARALIZADO', 'QUEMADO', 'ENVENENADO', 'GRAVEMENTE ENVENENADO', 'DORMIDO', 'CONGELADO', 'HELADO', 'SOMNOLIENTO', 'POKERUS', 'DEBILITADO', 'CONFUSO', 'ENAMORADO', 'ATRAPADO', 'MALDITO', 'DRENADORAS', 'CANTO MORTAL', 'CENTRO DE ATENCION', 'AMEDRENTADO' )),
    TURNOS INT(1),
    -- MEJORA
    MEJORA VARCHAR(20),
...
(0012, 'Guillotina', 'Ataque cortante con grandes pinzas que fulmina al objetivo de un solo golpe si acierta.', NULL, 5, 'ATAQUE', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
...
(0014, 'Danza Espada', 'Este frenético baile de combate eleva el espíritu y aumenta mucho el Ataque.', NULL, 30, 'MEJORA', 'NORMAL', NULL, NULL, 1, 'ATAQUE+', 0, 2),
...
(0018, 'Remolino', 'Se lleva al objetivo, que es cambiado por otro Pokémon. Si es un Pokémon salvaje, acaba el combate.', 100, 20, 'ESTADO', 'NORMAL', NULL, 'ATRAPADO', 1, NULL, 0, NULL),
...
(0028, 'Ataque Arena', 'Arroja arena a la cara del objetivo y reduce su Precisión.', 100, 15, 'ESTADO', 'NORMAL', NULL, NULL, 1, 'PRECISION-', 0, 1),
...
(0032, 'Perforador', 'Ataque con un cuerno giratorio que fulmina al objetivo de un solo golpe si acierta.', 30, 5, 'ATAQUE', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
...
(0039, 'Látigo', 'Agita la cola para despistar al objetivo y reducir su Defensa.', 100, 30, 'ESTADO', 'NORMAL', NULL, NULL, 1, 'DEFENSA-', 0, 1),
...
(0043, 'Malicioso', 'Intimida al objetivo con una mirada torva para reducir su Defensa.', 100, 30, 'ESTADO', 'NORMAL', NULL, NULL, 1, 'DEFENSA-', 0, 1),
(0044, 'Mordisco', 'Un voraz bocado con dientes afilados que puede amedrentar al objetivo.', 100, 25, 'ATAQUE', 'OSCURO', 60, 'AMEDRENTADO', 1, NULL, 0, NULL),
(0045, 'Gruñido', 'Dulce gruñido que distrae al objetivo para que baje la guardia y reduce su Ataque.', 100, 40, 'ESTADO', 'NORMAL', NULL, NULL, 1, 'ATAQUE-', 0, 1),
(0046, 'Rugido', 'Se lleva al objetivo, que es cambiado por otro Pokémon. Si es un Pokémon salvaje, acaba el combate.', 100, 20, 'ESTADO', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
(0047, 'Canto', 'Cantinela que hace dormir profundamente al objetivo.', 55, 15, 'ESTADO', 'NORMAL', NULL, 'DORMIDO', 1, NULL, 0, NULL),
(0048, 'Supersónico', 'El cuerpo del usuario emite unas ondas sónicas raras que confunden al objetivo.', 55, 20, 'ESTADO', 'NORMAL', NULL, 'CONFUSO', 1, NULL, 0, NULL);
(0049, 'Bomba Sónica', 'Lanza ondas de choque que restan 20 PS al objetivo.', 90, 20, 'ATAQUE', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
(0050, 'Anulación', 'Anula el último movimiento usado por el objetivo durante cuatro turnos.', 100, 20, 'ESTADO', 'NORMAL', NULL, NULL, 4, NULL, 0, NULL),
...
(0054, 'Neblina', 'Rodea de una niebla blanquecina al bando del usuario e impide que el rival reduzca sus características durante cinco turnos.', NULL, 30, 'ESTADO', 'HIELO', NULL, NULL, 5, NULL, 0, NULL),
...
(0067, 'Patada Baja', 'Patada baja que derriba al objetivo.', 100, 20, 'ATAQUE', 'LUCHA', NULL, NULL, 1, NULL, 0, NULL),
(0068, 'Contraataque', 'Con más peso este, más daño le causa.', 100, 20, 'ATAQUE', 'LUCHA', NULL, NULL, 1, NULL, 0, NULL),
(0069, 'Sísmico', 'Aprovecha la gravedad para derribar al objetivo. Le resta tantos PS como nivel tenga el usuario.', 100, 20, 'ATAQUE', 'LUCHA', NULL, NULL, 1, NULL, 0, NULL),
...
(0073, 'Drenadoras', 'Planta semillas que absorben PS del objetivo en cada turno y que le sirven para recuperarse.', 90, 10, 'ESTADO', 'PLANTA', NULL, 'DRENADORAS', 5, NULL, 0, NULL),
(0074, 'Desarrollo', 'Hace que su cuerpo crezca a marchas forzadas, con lo que aumenta su Ataque y su Ataque Especial.', NULL, 20, 'MEJORA', 'NORMAL', NULL, NULL, 1, 'ATAQUE+', 0, 1),
...
(0077, 'Polvo Veneno', 'Esparce polvo tóxico que envenena al objetivo.', 75, 35, 'ESTADO', 'VENENO', NULL, 'ENVENENADO', 1, NULL, 0, NULL),
(0078, 'Paralizador', 'Esparce polvo que paraliza al objetivo.', 75, 30, 'ESTADO', 'PLANTA', NULL, 'PARALIZADO', 1, NULL, 0, NULL),
(0079, 'Somnífero', 'Esparce polvo que duerme al objetivo.', 75, 15, 'ESTADO', 'PLANTA', NULL, 'DORMIDO', 1, NULL, 0, NULL),
...
(0081, 'Disparo Demora', 'Lanza seda por la boca al objetivo y reduce mucho su Velocidad.', 95, 40, 'ESTADO', 'BICHO', NULL, NULL, 1, 'VELOCIDAD-', 0, 1),
(0082, 'Furia Dragón', 'Ráfaga de furiosas ondas de choque que quitan 40 PS.', 100, 10, 'ATAQUE', 'DRAGON', NULL, NULL, 1, NULL, 0, NULL),
...
(0086, 'Onda Trueno', 'Una ligera descarga que paraliza al objetivo.', 90, 20, 'ESTADO', 'ELECTRICO', NULL, 'PARALIZADO', 1, NULL, 0, NULL),
...
(0090, 'Fisura', 'Abre una grieta en el suelo y mete al objetivo en ella. Fulmina al objetivo de un solo golpe si acierta.', 30, 5, 'ATAQUE', 'TIERRA', NULL, NULL, 1, NULL, 0, NULL),
(0091, 'Excavar', 'El usuario cava durante el primer turno y ataca en el segundo.', 100, 10, 'ATAQUE', 'TIERRA', 80, NULL, 2, NULL, 0, NULL),
(0092, 'Tóxico', 'Envenena gravemente al objetivo y causa un daño mayor en cada turno.', 90, 10, 'ESTADO', 'VENENO', NULL, 'GRAVEMENTE ENVENENADO', 1, NULL, 0, NULL),
...
(0095, 'Hipnosis', 'Ataque hipnótico que hace dormir profundamente al objetivo.', 60, 20, 'ESTADO', 'PSIQUICO', NULL, 'DORMIDO', 1, NULL, 0, NULL),
(0096, 'Meditación', 'El usuario reposa y medita para potenciar el Ataque.', NULL, 40, 'MEJORA', 'PSIQUICO', NULL, NULL, 1, 'ATAQUE+', 0, 1),
(0097, 'Agilidad', 'Relaja y aligera el cuerpo para aumentar mucho la Velocidad.', NULL, 30, 'MEJORA', 'PSIQUICO', NULL, NULL, 1, 'VELOCIDAD+', 0, 2),
...
(0100, 'Teletransporte', 'Permite al usuario cambiarse por otro Pokémon del equipo, si lo hay. Si un Pokémon salvaje usa este movimiento, huye del combate.', NULL, 20, 'ESTADO', 'PSIQUICO', NULL, NULL, 1, NULL, 0, NULL),
(0101, 'Tinieblas', 'Produce un espejismo ante el objetivo, que pierde tantos PS como nivel tenga el usuario.', 100, 15, 'ATAQUE', 'FANTASMA', NULL, NULL, 1, NULL, 0, NULL),
(0102, 'Mimético', 'Copia el último movimiento usado por el objetivo, y puede utilizarlo mientras esté en el combate.', NULL, 10, 'ESTADO', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
(0103, 'Chirrido', 'Chillido agudo que reduce mucho la Defensa del objetivo.', 85, 40, 'ESTADO', 'NORMAL', NULL, NULL, 1, 'DEFENSA-', 0, 2),
(0104, 'Doble Equipo', 'El usuario se mueve a velocidad vertiginosa y crea copias ilusorias de sí mismo, con lo que aumenta su Evasión al desconcentrar al rival.', NULL, 15, 'MEJORA', 'NORMAL', NULL, NULL, 1, 'EVASION+', 0, 1),
(0105, 'Recuperación', 'El usuario regenera sus células y recupera una cantidad de PS equivalente a la mitad de sus PS máximos.', NULL, 5, 'ESTADO', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
(0106, 'Fortaleza', 'El usuario tensa su musculatura para aumentar la Defensa.', NULL, 30, 'MEJORA', 'NORMAL', NULL, NULL, 1, 'DEFENSA+', 0, 1),
(0107, 'Reducción', 'El usuario mengua para aumentar mucho la Evasión.', NULL, 10, 'MEJORA', 'NORMAL', NULL, NULL, 1, 'EVASION+', 0, 2),
(0108, 'Pantalla de Humo', 'Reduce la Precisión del objetivo con una nube de humo o tinta.', 100, 20, 'ESTADO', 'NORMAL', NULL, NULL, 1, 'PRECISION-', 0, 1),
(0109, 'Rayo Confuso', 'Rayo siniestro que confunde al objetivo.', 100, 10, 'ESTADO', 'FANTASMA', NULL, 'CONFUSO', 1, NULL, 0, NULL),
(0110, 'Refugio', 'El usuario se resguarda en su coraza, por lo que le aumenta la Defensa.', NULL, 40, 'MEJORA', 'NORMAL', NULL, NULL, 1, 'DEFENSA+', 0, 1),
(0111, 'Rizo Defensa', 'Se enrosca para ocultar sus puntos débiles y aumenta la Defensa.', NULL, 40, 'MEJORA', 'NORMAL', NULL, NULL, 1, 'DEFENSA+', 0, 1),
(0112, 'Barrera', 'Crea una barrera que aumenta mucho la Defensa.', NULL, 20, 'MEJORA', 'PSIQUICO', NULL, NULL, 1, 'DEFENSA+', 0, 2),
(0113, 'Pantalla de Luz', 'Barrera misteriosa que reduce durante cinco turnos el daño producido por los ataques especiales del rival.', NULL, 30, 'MEJORA', 'PSIQUICO', NULL, NULL, 5, NULL, 0, NULL),
(0114, 'Niebla', 'Neblina oscura que elimina los cambios en las características de todos los Pokémon en combate.', NULL, 30, 'ESTADO', 'HIELO', NULL, NULL),
(0115, 'Reflejo', 'Barrera misteriosa que reduce durante cinco turnos el daño producido por los ataques físicos del rival.', NULL, 20, 'MEJORA', 'PSIQUICO', NULL, NULL, 5, NULL, 0, NULL),
(0116, 'Foco Energía', 'Concentra energía para aumentar las posibilidades de asestar un golpe crítico.', NULL, 30, 'MEJORA', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
(0117, 'Venganza', 'Espera dos turnos para atacar con el doble de potencia del daño recibido.', 100, 10, 'ATAQUE', 'NORMAL', NULL, NULL, 2, NULL, 0, NULL),
(0118, 'Metrónomo', 'Mueve un dedo y estimula su cerebro para usar al azar casi cualquier movimiento.', NULL, 10, 'ESTADO', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
(0119, 'Espejo', 'Ataca al objetivo con el último movimiento que este haya usado.', NULL, 20, 'ATAQUE', 'VOLADOR', NULL, NULL, 1, NULL, 0, NULL),
...
(0129, 'Rayo Estrella', 'Lanza rayos en forma de estrella que no fallan nunca.', NULL, 20, 'ATAQUE', 'NORMAL', 60, NULL, 1, NULL, 0, NULL),
...
(0131, 'Clavo Cañón', 'Enquista los sueños de un objetivo dormido. El usuario recupera la mitad de los PS del daño que produce.', 100, 15, 'ATAQUE', 'PSIQUICO', NULL, NULL, 1, NULL, 0, NULL),
...
(0133, 'Amnesia', 'El usuario olvida sus preocupaciones y aumenta mucho la Defensa Especial.', NULL, 20, 'MEJORA', 'PSIQUICO', NULL, NULL, 1, 'DEFENSA ESPECIAL+', 0, 2),
(0134, 'Kinético', 'Debilita una cuchara para distraer al objetivo y reducir su Precisión.', 80, 15, 'ESTADO', 'PSIQUICO', NULL, NULL, 1, 'PRECISION-', 0, 1),
(0135, 'Ovocuración', 'Restaura la mitad de los PS máximos del usuario.', NULL, 5, 'ESTADO', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
...
(0137, 'Deslumbrar', 'Intimida y asusta al objetivo con la mirada para dejarlo paralizado.', 75, 30, 'ESTADO', 'NORMAL', NULL, 'PARALIZADO', 1, NULL, 0, NULL),
...
(0139, 'Gas Venenoso', 'Lanza una nube de gas tóxico al rostro del objetivo. Produce envenenamiento.', 90, 40, 'ESTADO', 'VENENO', NULL, 'ENVENENADO', 1, NULL, 0, NULL),
...
(0142, 'Beso Amoroso', 'Intimida al objetivo con una cara que asusta y le da un beso que lo deja dormido.', 75, 10, 'ESTADO', 'NORMAL', NULL, 'DORMIDO', 1, NULL, 0, NULL),
...
(0144, 'Transformación', 'El usuario se transforma en una copia del objetivo, con los mismos movimientos.', NULL, 10, 'ESTADO', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
...
(0147, 'Espora', 'Esparce esporas que inducen el sueño.', 100, 15, 'ESTADO', 'PLANTA', NULL, 'DORMIDO', 1, NULL, 0, NULL),
(0148, 'Destello', 'Luz cegadora que baja la Precisión del objetivo.', 100, 20, 'ESTADO', 'NORMAL', NULL, NULL, 1, 'PRECISION-', 0, 1),
(0149, 'Psicoonda', 'Ataca con una onda de energía de intensidad variable.', 100, 15, 'ATAQUE', 'PSIQUICO', NULL, NULL, 1, NULL, 0, NULL),
(0150, 'Salpicadura', 'No tiene ningún efecto. Solo salpica.', NULL, 40, 'ESTADO', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
(0151, 'Armadura Ácida', 'Transforma su estructura celular para hacerse líquido y aumentar mucho la Defensa.', NULL, 20, 'MEJORA', 'VENENO', NULL, NULL, 1, 'DEFENSA+', 0, 2),
...
(0156, 'Descanso', 'Restaura todos los PS y cura todos los problemas de estado del usuario, que se duerme los dos turnos siguientes.', NULL, 5, 'ESTADO', 'PSIQUICO', NULL, NULL, 2, NULL, 0, NULL),
...
(0159, 'Afilar', 'El perfil del usuario se hace más afilado y su Ataque mejora.', NULL, 30, 'MEJORA', 'NORMAL', NULL, NULL, 1, 'ATAQUE+', 0, 1),
(0160, 'Conversión', 'Cambia el tipo del usuario por el del primer movimiento en su lista.', NULL, 30, 'MEJORA', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
...
(0162, 'Superdiente', 'Asesta una dentellada con sus afilados incisivos que reduce a la mitad los PS del objetivo.', 90, 10, 'ATAQUE', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
...
(0164, 'Sustituto', 'Utiliza parte de los PS propios para crear un sustituto que actúa como señuelo.', NULL, 10, 'ESTADO', 'NORMAL', NULL, NULL, 1, NULL, 0, NULL),
