 ...
 * 
 * @param Gestiona la autenticación, registro de nuevos usuarios y navegación al
 *                 menú principal.
 */
...
public class LoginController {
	...
	/**
	 * 
	 * Metodo para verificar los datos los datos del usuario y si no estan
	 * guardados, se pide crear el usuario directamente.
	 * 
	 * 
	...
	/**
	 * 
	 * Metodo para registrar el nombre y contraseña de usuario dentro de la base de
	 * datos.
	 * 
	 * 
	...
	/**
	 * 
	 * Metodo para abrir la pantalla del menu despues de iniciar sesion con el
	 * usuario.
	 * 
	 * 
	 * 
	 * @param event. Evento del mouse al hacer clic sobre el botón de iniciar
	 *               sesion.
	 * 
	...
	/**
	 * 
	 * Metodo para mostrar la ventana del login vaciando los bloques de texto en
	 * Usuario y Contraseña.
	 * 
	 * 
	 */

	// Vuelve a mostrar la ventana de inicio de sesión y limpia los campos de
	// usuario y contraseña.
	public void show() {
		stage.show();
		txtUsuario.setText("");
