...
public class EntrenamientoController {
    ...
    @FXML private ImageView imgPokeRival;
    @FXML private Button btnSalir;
    @FXML private Button btnPokemon;
    @FXML private Button btnMov1;
    @FXML private Button btnMov2;
    @FXML private Button btnMov3;
    @FXML private Button btnMov4;
    @FXML private ProgressBar hpPokemon;
    @FXML private ProgressBar hpPokemonRival;
    ...
    @FXML
    public void hacerMov1(ActionEvent event) { usarMovimiento(0); }
    @FXML
    public void hacerMov2(ActionEvent event) { usarMovimiento(1); }
    @FXML
    public void hacerMov3(ActionEvent event) { usarMovimiento(2); }
    @FXML
    public void hacerMov4(ActionEvent event) { usarMovimiento(3); }
    ...
    private void usarMovimiento(int index) {
        List<Movimiento> movimientos = miPokemon.getMovPrincipales();
        if (index >= movimientos.size()) return; // Si no existe ese movimiento, no hacer nada
        ...
        // Si rival queda sin vida, mostramos mensaje de victoria
    ...
    public void cambiarPoke(ActionEvent event) {
        mostrarAlerta("Función de cambiar Pokémon aún no implementada.");
    }
