...
public class CambiarPokemonPrincipalController {
    ...
    void cambiarPor(ActionEvent event) {
	   ...
	   // Cambiar el Pokémon de la caja con el principal
	    cambiado = PokemonBD.cambiarPokemonPrincipal(entrenador.getIdEntrenador(), PokemonBD.obtenerPokemonPrincipal(entrenador.getIdEntrenador()), pokemonSeleccionadoDeEquipo);
