...
public class Pokemon {
    ...
    private int vecesEnCombate = 0;
    private int vecesCurado = 0;
    ...
    public Pokemon(Pokemon c) {
        ...
        this.movPrincipales = new LinkedList<>(c.movPrincipales);
        this.movSecundarios = new LinkedList<>(c.movSecundarios);
    }
    ...
    /**
     * Incrementa el contador de veces que este Pokémon ha estado en combate.
     */
    ...
    /**
     * Incrementa el contador de veces que este Pokémon ha sido curado.
     */
    public void registrarCuracion() {
        vecesCurado++;
    }

    /**
     * Guarda el nombre del último movimiento usado.
     */
    public void setUltimoMovimientoUsado(String movimiento) {
        this.ultimoMovimientoUsado = movimiento;
    }

    /**
     * Devuelve el número de veces que este Pokémon ha estado en combate.
     */
    public int getVecesEnCombate() {
        return vecesEnCombate;
    }

    /**
     * Devuelve el número de veces que este Pokémon ha sido curado.
     */
    public int getVecesCurado() {
        return vecesCurado;
    }
